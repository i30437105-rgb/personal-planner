...
export const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', zIndex: 1000, overflowX: 'hidden', overflowY: 'auto', boxSizing: 'border-box' }} onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} style={{ width: '100%', maxWidth: '500px', maxHeight: '85vh', background: COLORS.bgCard, borderRadius: '24px 24px 0 0', border: `1px solid ${COLORS.border}`, borderBottom: 'none', overflow: 'hidden', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', margin: '0 auto', flexShrink: 0 }}>
        ...
        <div style={{ padding: '20px', overflowY: 'auto', overflowX: 'hidden', flex: 1, boxSizing: 'border-box' }}>{children}</div>
      </div>
    </div>
  );
};
